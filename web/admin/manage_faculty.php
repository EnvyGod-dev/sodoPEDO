	...
	<form action="" id="manage-faculty">
		...
		<div class="row form-group">
			<div class="col-md-4">
						...
						<small><i>Хэрэв та ID дугаарыг автоматаар үүсгэхийг хүсвэл үүнийг хоосон орхино уу.</i></small>
					</div>
		</div>
		<div class="row form-group">
			<div class="col-md-4">
			...
			<div class="col-md-4">
				<label class="control-label">Ургын овог</label>
		...
		<div class="row form-group">
			...
			<div class="col-md-4">
				...
				<select name="gender" required="" class="custom-select" id="">
					<option <?php echo isset($gender) && $gender == 'Male' ? 'selected' : '' ?>>эр</option>
					<option <?php echo isset($gender) && $gender == 'Female' ? 'selected' : '' ?>>эм</option>
				</select>
			</div>
		</div>
		<div class="row form-group">
