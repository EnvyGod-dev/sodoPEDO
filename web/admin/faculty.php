		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="card">
					...
					<i class="fa fa-plus"></i> Шинэ</button>
				</span>
					</div>
					<div class="card-body">
						...
						<table class="table table-bordered table-condensed table-hover">
							...
							<thead>
								<tr>
									...
									<th class="">ID дугаар</th>
									<th class="">нэр</th>
									<th class="">майл хаяг</th>
									<th class="">Холбоо барих</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-primary view_faculty" type="button" data-id="<?php echo $row['id'] ?>" >Харах</button>
										<button class="btn btn-sm btn-outline-primary edit_faculty" type="button" data-id="<?php echo $row['id'] ?>" >Засах</button>
										<button class="btn btn-sm btn-outline-danger delete_faculty" type="button" data-id="<?php echo $row['id'] ?>">Устгах</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
