...
<html>
<head>
    <title>How to directly Print PDF Commands without Preview or Printer Dialog</title>
</head>
<body>
    ...
    //PrintPDFController.php is at the same page level as WebClientPrint.php
    $printPDFControllerAbsoluteURL = substr($currentAbsoluteURL, 0, strrpos($currentAbsoluteURL, '/')).'/PrintPDFController.php';
    
    //Specify the ABSOLUTE URL to the WebClientPrintController.php and to the file that will create the ClientPrintJob object
    echo WebClientPrint::createScript($webClientPrintControllerAbsoluteURL, $printPDFControllerAbsoluteURL, session_id());
    ?>
