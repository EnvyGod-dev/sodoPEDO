...
<div class="container-fluid">
	...
	<div class="row">
	<div class="col-lg-12">
			<button class="btn btn-primary float-right btn-sm" id="new_user"><i class="fa fa-plus"></i> Шинэ хэрэглэгч</button>
	</div>
	</div>
	<br>
	<div class="row">
				...
				<?php
				 ...
				 <tr>
				 	...
				 	<td>
				 		<center>
								<div class="btn-group">
								  <button type="button" class="btn btn-primary">Үйлдэл</button>
